...
public class MapReduceSourceCode extends MapReduce {
 ...
 /* main function */
	...
	{
		MapReduceSourceCode pcode = new MapReduceSourceCode();   // create object to access the abstract MapReduce methods
